...
// Returns the public 'AppBundle\Controller\TarifController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/AppBundle/Controller/TarifController.php';

return $this->services['AppBundle\Controller\TarifController'] = new \AppBundle\Controller\TarifController();
