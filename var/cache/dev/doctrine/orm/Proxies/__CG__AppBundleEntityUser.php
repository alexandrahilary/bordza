...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'inscriptions', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setInscriptions()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInscriptions', []);

        return parent::setInscriptions();
    }
     ...
     * {@inheritDoc}
     */
    public function removeIscription(\AppBundle\Entity\Inscription $inscription)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIscription', [$inscription]);

        return parent::removeIscription($inscription);
    }
